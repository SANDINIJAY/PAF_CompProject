				...
				<legend><b>Add Product Details</b></legend>
					<form id="PRODUCT" name="PRODUCT" class="border border-light p-5">
						...
						<div class="form-outline mb-4">
						    <label class="form-label" for="form6Example3" class="col-sm-2 col-form-label col-form-label-sm">Product ID</label>
						    <input type="hidden" id="ID" name="ID">
						    <input type="text" id="ProID" class="form-control" name="ProID">						    
						</div>
						...
						<div class="form-outline mb-4">
						    <label class="form-label" for="form6Example3" class="col-sm-2 col-form-label col-form-label-sm">Product Grade</label>
						    <input type="text" id="ProGrade" class="form-control" name="ProGrade">						    
						</div>
						
						<div class="form-outline mb-4">
						    <label class="form-label" for="form6Example3" class="col-sm-2 col-form-label col-form-label-sm">Product Price</label>
						    <input type="text" id="ProPrice" class="form-control" name="ProPrice">						    
						</div>
